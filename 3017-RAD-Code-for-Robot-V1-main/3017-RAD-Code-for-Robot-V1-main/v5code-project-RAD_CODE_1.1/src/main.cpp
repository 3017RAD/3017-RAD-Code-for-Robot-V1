...
void usercontrol(void) {
  ...
  while (1) {
     ...
     LeftDriveMotorA.spin(reverse);
     LeftDriveMotorB.spin(reverse);
     X = Controller1.Axis2.position(percent);
     Y = Controller1.Axis4.position(percent);
     RightDriveMotorA.setVelocity( Y - X, pct) ;
      RightDriveMotorB.setVelocity( Y - X, pct) ;
     LeftDriveMotorB.setVelocity( Y + X , pct ); 
    LeftDriveMotorA.setVelocity( Y + X , pct ); 
